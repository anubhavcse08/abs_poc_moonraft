...
const TopHeader = (prop) => {
  ...
  return (
    <div class="sticky top-0 z-50 bg-slate-100 px-3 md:px-5 py-2">
      <div class="flex items-center text-xs">
        ...
        <div className="search-box relative text-xs md:w-3/12 hidden md:block">
        ...
        <div className="header-icons flex gap-3 md:gap-4 ml-auto">
          <span class="text-slate-400 search-icon md:hidden">
            <i class="bi bi-search"></i>
          </span>
          <a href="#">
            <i
