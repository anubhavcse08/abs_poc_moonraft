...
const GraphCard = (props) => {
    const { options: { title, actualAmount, tagetAmount, growthPercent }, isGrowth } = props;
    // useEffect(() => {
    //     windowResizable();
    // //   return () => {
    // //     second
    ...
    return (
        <div className='card-layout'>
            <div className='card-title item-flex-row'>
                ...
                <div className={`growth-amount ${isGrowth ? 'growth-up' : 'growth-down'}`}>
                    {isGrowth ? <span className='arrow-up'>&#8593; </span> :
            ...
            <div className='graph-amount-label item-flex-row'>
                <div className='amount-details item-flex-column'>
                    ...
                    <div className='target-amount'>{tagetAmount} <span className='target-label'>Target</span></div>
                </div>
